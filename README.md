...
DingoDB is past pure-spec: Stages **0–7** land in-tree, plus **Stage 8a–8c**
...
(partitions, coverage, per-partition Raft elections and commit evidence).
...
| 8 | Cluster | **8a–8c done** — `dingo-cluster` + Raft + convergent-append; 8d+ open |
| 9 | Tiering | later |

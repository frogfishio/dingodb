...
do **not** treat it as a production release: repair, distributed query
completeness, Jepsen-style verification, and other §16 gates remain open
(DEF-039+; durable rebalance control plane is DEF-038).

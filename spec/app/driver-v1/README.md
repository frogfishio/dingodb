...
status. The SDK now contains a bounded embedded async driver with cloneable
Heap-bound handles and idempotent mutations. It does not yet claim the remote
pool, streamed RQL, or cancellation-after-dispatch portions of the full driver.

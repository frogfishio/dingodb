//! S3 product capacity path — multi-partition batch put on dingo-cluster.
//!
...
use dingo_cluster::{Cluster, ClusterConfig, ConsistencyMode, DeploymentProfile, NodeId, ReadMode};

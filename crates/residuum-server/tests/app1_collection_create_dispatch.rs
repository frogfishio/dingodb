...
use residuum_store::{publish_staged_genesis, stage_heap_genesis, Store, StoreHost};
use std::sync::Arc;
use tempfile::TempDir;

fn mint_admin_cap(heap: HeapId, deployment: DeploymentId) -> residuum_heap::HeapCap {

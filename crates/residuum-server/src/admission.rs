...
//! slots ([`crate::runtime`]) and host resource ceilings ([`residuum_sdk::resource`]):
//!
...
//!
//! Overload answers use [`residuum_sdk::ErrorCode::ResourceLimit`] (`resource_limit`).
//! Auth lockouts use [`residuum_sdk::ErrorCode::AuthenticationFailed`] with a generic

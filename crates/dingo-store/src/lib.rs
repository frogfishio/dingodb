...
pub use heap::{
    ...
    HeapRetentionPolicy, HeapStore, HsmDataKeyProvider, IdentityTombstone, IncompletePurgeResult,
    InProcessDataKeyProvider, InventoryFrame, InventorySegment, MaintenanceStore, MediaDomain,
    MigrationPhase, MigrationStateV1, MixedHeapSalvageClass, ObjectCatalogEntry, ObjectKind,

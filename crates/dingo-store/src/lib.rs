...
pub use heap::{
    ...
    HeapLifecycle, HeapMetaLayout, HeapMigrationJob, HeapStore, IdentityTombstone, InventoryFrame,
    InventorySegment, MaintenanceStore, MigrationPhase, MigrationStateV1, ObjectCatalogEntry,
    ObjectKind, PayloadOnlyRestore, PurgePlan, PurgeReceipt, RecoveryStore, ReplicaStore,

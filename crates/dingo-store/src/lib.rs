...
pub use heap::{
    ...
    collection_create_binding, create_object, decode_purge_receipt, delete_rebuildable_catalogs,
    ...
    load_admin_op_dedup, load_identity_tombstone, load_staged_genesis,
    ...
    AdminOpDedupTable, AdminReceipt, CutoverGate, DataKeyDestructionReceipt, DataKeyHandle,
    DataKeyProvider, DisasterRecoveryCeremony, DisasterRecoveryPackage,
    DisasterRecoveryTakeoverResult, HeapBackupManifest, HeapCatalogEntry, HeapLifecycle,
    HeapMetaLayout, HeapMigrationJob, HeapRetentionPolicy, HeapStore, HsmBackendKind,
    HsmCapabilities, HsmDataKeyConfig, HsmDataKeyProvider, IdentityTombstone, IncompletePurgeResult,
    ...
    ADMIN_OP_DEDUP_FILE, COLLECTION_CREATE_OP,

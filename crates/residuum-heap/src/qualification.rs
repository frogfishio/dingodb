...
//!
//! The product MAY advertise the qualified `residuum-heap-v1` profile only when
...
/// Whether this build may advertise a qualified `residuum-heap-v1` claim.
///
...
pub const QUALIFIED_PROFILE: &str = "residuum-heap-v1";

/// Product language required before Gate H6 (§27).
pub const PRE_QUALIFICATION_LANGUAGE: &str = concat!(
    "DingoDB provides named heap namespaces; strong access-isolation ",

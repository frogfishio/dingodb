...
pub use driver_contract::{
    DriverLimits, OperationId, RequestId, RequestStage, RetryDisposition, TerminalOutcome,
    FEATURE_CANCEL_REQUEST_V1, FEATURE_COMPLETE_RECEIPTS_V2, FEATURE_OPERATION_OUTCOME_V1,
    FEATURE_REQUEST_DEADLINE_V1, REQUIRED_ASYNC_DRIVER_FEATURES,
};
pub use error::{Error, ErrorCode};
pub use heap_handshake::{
    b64u_decode, b64u_encode, HeapAuth, HeapChallenge, HeapReject, HeapWelcome,
    FEATURE_HEAP_KEY_V1, HEAP_AUDIENCE_DATA_V1, HEAP_AUTH_MAX_BYTES,
};
pub use protocol::{
    ...
    read_frame_or_detect_legacy, server_handshake, write_frame, write_json_frame,
    write_reject_frame, Handshake, HandshakeMsg, NegotiatedSession, DEFAULT_MAX_FRAME_BYTES,
    DEFAULT_MAX_RPC_LINE_BYTES, DEFAULT_SERVER_PROFILE, FEATURE_IDEMPOTENCY_V1,

//! S3 product capacity path — multi-partition batch put on residuum-cluster.
//!
...
use residuum_cluster::{Cluster, ClusterConfig, ConsistencyMode, DeploymentProfile, NodeId, ReadMode};

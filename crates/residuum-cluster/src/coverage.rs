...
impl QueryContinuation {
    ...
    pub fn encode(
        ...
        keyring: &residuum_store::ContinuationKeyring,
...
mod tests {
    ...
    fn continuation_roundtrip() {
        ...
        let ring = residuum_store::ContinuationKeyring::mint_new().unwrap();
    ...
    fn continuation_rejects_foreign_keyring() {
        ...
        let tok = cont.encode(cid, &ring).unwrap();
        let attacker = residuum_store::ContinuationKeyring::mint_new().unwrap();

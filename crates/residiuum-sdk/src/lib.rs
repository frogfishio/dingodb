...
pub use query_bytecode_v1::{
    apply_project_paths, apply_project_rows, attach_enrich_rows, attach_within_rows,
    build_sort_tuple, cmp_sort_tuples, compile_rql_full, compare_rows, decode_isa,
    ...
    execute_rql_full, execute_rql_full_with, explain_core_source, explain_rql_full,
    explain_rql_full_on_heap, explain_rql_source, filter_rows, isa_hash, key_from_sort_tuple,
    lower_core_source, refuse_full_language_on_core_wire, retain_after_sort_tuple,
    source_uses_rql_full_constructs, CompiledOrderIr, CompiledProjectIr, CompiledRqlFull, DocScan,
    EnrichAttachMode, EnrichCardinality, EnrichLoadEvidence, EnrichStepV1, FullPipelineStepV1,
    HostCapabilities, ProjectItemV1, QueryBytecodeV1, QueryIsaFullSection, QueryIsaProgram,
    RqlFullExecuteOptions, RqlFullPage, WithinStepV1, BYTECODE_PROFILE,
    ...
    ISA_PROFILE, ISA_VERSION, KERNEL_PROFILE, MAX_PROJECT_DEPTH, MAX_WITHIN_DEPTH,
    ORDER_IR_PROFILE, PROJECT_IR_PROFILE, RQL_FULL_PROFILE, compile_where, lower_predicate,
    CompiledKernelWhere,
};

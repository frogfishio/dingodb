...
//! catalog-independent recovery via [`residuum_format`] salvage scanning.
//!
...
pub use residuum_format::{ByteRange, LogicalExtent};
...
/// Local-only staged genesis / publish used by `residuum-authority` (HP-005).

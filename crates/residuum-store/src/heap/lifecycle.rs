...
pub const HEAP_LIFECYCLE_PROFILE: &str = "residuum-heap-lifecycle-v1";
...
impl HsmDataKeyConfig {
    ...
    pub fn mock_in_process() -> Self {
        Self {
            ...
            key_label: Some("residuum-heap-test".into()),
            mock_enabled: true,
        }
    }
...
pub fn active_snapshot(
    deployment_id: residuum_heap::DeploymentId,
    heap_id: HeapId,
    ...
    Ok(HeapSecuritySnapshot {
        deployment_id,
        heap_id,
        authority_epoch: residuum_heap::AuthorityEpoch::new(1)
            .map_err(|e| StoreError::HeapAdmit(e.to_string()))?,
        authority_generation: residuum_heap::AuthorityGeneration::new(1)
            .map_err(|e| StoreError::HeapAdmit(e.to_string()))?,
        previous_generation: None,
        grace_deadline_unix_s: None,
        master_public_key,

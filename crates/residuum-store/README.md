...
Most applications should use [`residuum-sdk`](https://crates.io/crates/residuum-sdk)
...
| You want… | Use |
|-----------|-----|
| Named collections, JSON, filters, remote connect | [`residuum-sdk`](https://crates.io/crates/residuum-sdk) |
| Subject-keyed store, salvage, tiering, durability modes | **`residuum-store`** (this crate) |
| Frame codec only | [`residuum-format`](https://crates.io/crates/residuum-format) |
| Multi-node partitions / Raft | [`residuum-cluster`](https://crates.io/crates/residuum-cluster) |
...
```rust
use residuum_store::{DurabilityMode, MigrateOptions, MigratePhase, Store};
...
declared in `residuum-format` (`wire_compat_matrix` / `SUPPORTED_READER_MAJORS`).
...
```rust
use residuum_store::{DurabilityMode, ScrubOptions, Store};
...
```rust
use residuum_store::{restore_full_backup, DurabilityMode, RestoreOptions, Store};
...
([`residuum-format`](https://crates.io/crates/residuum-format)).
...
- `replicated` durability — see [`residuum-cluster`](https://crates.io/crates/residuum-cluster)

## Related crates

| Crate | License | Role |
|-------|---------|------|
| [`residuum-format`](https://crates.io/crates/residuum-format) | MIT | Wire format this store writes |
| [`residuum-sdk`](https://crates.io/crates/residuum-sdk) | MPL-2.0 | Collection API over this store |
| [`residuum-examine`](https://crates.io/crates/residuum-examine) | MPL-2.0 | SDA examination over salvage |
| [`residuum-cluster`](https://crates.io/crates/residuum-cluster) | AGPL-3.0-or-later | Multi-node federation |

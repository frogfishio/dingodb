...
in [`residuum-sdk`](https://crates.io/crates/residuum-sdk); TCP serve lives in
[`residuum-server`](https://crates.io/crates/residuum-server).
...
| Crate | License | Role |
|-------|---------|------|
| [`residuum-sdk`](https://crates.io/crates/residuum-sdk) | MPL-2.0 | Collection API (embedded + remote) |
| [`residuum-server`](https://crates.io/crates/residuum-server) | AGPL-3.0-or-later | TCP accept loop and RPC dispatch |
| [`residuum-format`](https://crates.io/crates/residuum-format) | MIT | On-disk survival wire format (not network RPC) |

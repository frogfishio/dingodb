//! Thin DingoDB network client primitives (MIT).
//!
//! Framed RPC protocol (`dingo-rpc-v1`) and handshake only. Collection APIs:
//! [`dingo_sdk`](https://docs.rs/dingo-sdk). TCP serve: `dingo-server`.
...
pub use protocol::{
    ...
    DEFAULT_MAX_RPC_LINE_BYTES, DEFAULT_SERVER_PROFILE, FEATURE_IDEMPOTENCY_V1, FEATURE_JSON_RPC_V1,
    FEATURE_RECEIPTS_V1, HANDSHAKE_MAX_FRAME_BYTES, PROTOCOL_MAJOR, PROTOCOL_MINOR,
    PROTOCOL_PROFILE, REQUIRED_DELETE_RECEIPT_FIELDS, REQUIRED_FEATURES,

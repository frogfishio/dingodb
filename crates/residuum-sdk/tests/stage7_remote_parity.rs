...
use residuum_server::{ServeOptions, serve_store};
...
fn remote_put_is_idempotent_with_operation_id() {
    ...
    use residuum_server::handle_connection_with;

    use residuum_store::{EventKind, Store};
    ...
    let subject = residuum_sdk::encode_subject("docs", "k").unwrap();

...
use residuum_server::{ServeOptions, serve_cluster_node, serve_store};
...
fn client_cache_routes_and_refreshes_on_poisoned_leader() {
    ...
    let subject = {
        ...
        residuum_sdk::encode_subject("t", "k2").unwrap()
    };
...
fn multi_hop_and_kill_node_survivor() {
    use residuum_sdk::{PutOptions, RemoteClient};

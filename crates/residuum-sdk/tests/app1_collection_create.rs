...
use residuum_sdk::{DingoDeployment, ErrorCode};
use residuum_store::{publish_staged_genesis, stage_heap_genesis, HeapMetaLayout};
use std::sync::Arc;
use tempfile::tempdir;

fn mint_cap_for(heap: HeapId, deployment: DeploymentId) -> residuum_heap::HeapCap {
...
fn uuid() -> [u8; 16] {
    *residuum_heap::CollectionId::new_random().unwrap().as_bytes()
}

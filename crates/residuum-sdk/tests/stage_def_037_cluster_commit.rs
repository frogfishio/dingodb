...
use residuum_server::{AuthzPolicy, CLUSTER_COMMIT_PROFILE, FEATURE_CLUSTER_COMMIT_V1, FEATURE_RAFT_RPC_V1, ServeOptions, serve_cluster_node, serve_store_with};
...
fn feature_and_profile_labels() {
    ...
    assert_eq!(CLUSTER_COMMIT_PROFILE, "residuum-cluster-commit-v1");

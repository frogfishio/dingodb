...
use residuum_heap::{claim_language, may_advertise_qualified};
...
///
/// Never implies `residuum-heap-v1` qualification.
pub const FLAT_COLLECTION_SURFACE_LABEL: &str =
    "legacy-flat-sdk; not residuum-heap-v1 qualified; CPR-001";
...
pub fn flat_collection_claim_language() -> &'static str {
    "DingoDB provides a legacy flat collection API for compatibility; strong \
     ...
     residuum-heap-v1 after HP-010 gates accept."
}
...
/// Canonical Level-1 language (delegates to `residuum-heap`).

...
pub use recovery_shadow::{
    build_and_publish_shadow, candidate_config_label, contains_plaintext, current_protection_lag,
    decode_segment_for_candidate, decode_shadow, delete_shadow, encode_shadow,
    encode_shadow_from_live_map, enrich_segment_candidate, ensure_shadow_dirs, envelope_open,
    envelope_seal, evaluate_gates, every_protected_has_verified_rsh, is_recovery_shadow_path,
    list_sealed_segment_files, load_protected_coverage, load_protected_frontier, median_f64,
    note_segment_sealed, ols_slope, project_live, protected_frontier_path, protection_lag,
    protection_lag_from_coverage, publish_protected_coverage, publish_protected_frontier,
    publish_shadow, publish_shadow_claiming_protection, publish_shadow_timed, range_f64,
    rebuild_coverage_from_shadows, recovery_after_auth_compact_delete,
    reset_shadow_reclaim_policy_for_tests, retire_shadows_after_replacement,
    retire_shadows_after_replacement_with_policy, secure_erase_shadow, set_shadow_reclaim_policy,
    shadow_dir, shadow_path, shadow_reclaim_policy, snapshot_telemetry, stage_medians,
    try_load_shadow, DecodedShadow, LiveMap, LiveState, ProtectedCoverage, ProtectedFrontier,
    ...
    HARNESS_ENVELOPE_KEY, RSH_MAGIC, RSH_MAGIC_V1, TAG_PUT, TAG_TOMBSTONE,
};
pub use scrub::{

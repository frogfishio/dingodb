...
dingodb/
  crates/
    ...
    dingo-cli/      # `dingo` binary: put/get, doctor, salvage, backup/restore, scrub, serve (Stage 7) — AGPL
...
| 3+6+7 | `dingo-store` | **Present** — put/get/delete, salvage, open_inspect, salvage_to, backup_to/restore (DEF-050), scrub (DEF-051), catalogs, chunks, history, compact |
...
| 7 | `dingo-cli` | **Present** — `dingo` put/get/list/doctor/salvage/backup/restore/scrub/serve (serve via `dingo-server`) |

# Residiuum prime-time plan

Status: **archived strategy snapshot (captured 2026-07-28)**
Audience: product + engineering program operators (humans + agents)
Companions: [DEFECTS.md](../incidents/DEFECTS.md) (execution defects + §16 gates),
[WORK_HORIZON.md](./WORK_HORIZON.md) (are we polishing?),
[CAPABILITY_MATRIX.md](../../wip/status/CAPABILITY_MATRIX.md) (what is honest today),
[DELIVERY_PLAN.md](./DELIVERY_PLAN.md) (Stages 0–9 — **done**),
[PERFORMANCE_STRATEGIES.md](../../reference/operations/PERFORMANCE_STRATEGIES.md) (write/read path only)

Current integrated delivery order:
[MASTER_DELIVERY_PLAN.md](../../../MASTER_DELIVERY_PLAN.md). This document
must not be used as a current queue. Its maturity criteria remain historical
...
| Order | Wedge | When |
|------:|-------|------|
| 2 | Single-node `residiuum serve` for small teams | After security review + wire freeze path + soak evidence |
...
| Need | Open |
|------|------|
| What to build next (tactical IDs) | [DEFECTS.md](../incidents/DEFECTS.md) |
| Whether current labor is polish thrash | [WORK_HORIZON.md](./WORK_HORIZON.md) |
| What we may claim today | [CAPABILITY_MATRIX.md](../../wip/status/CAPABILITY_MATRIX.md) |
| Performance residual order only | [PERFORMANCE_STRATEGIES.md](../../reference/operations/PERFORMANCE_STRATEGIES.md) |

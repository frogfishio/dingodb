...
Status: **completed historical plan v0.23** (Stages 0–9 done; Doc P2 aligned;
product follow-ons 1–4 landed)
Audience: implementers
Depends on: [SDA_SPEC.md](../../reference/query/SDA_SPEC.md), [SDA_PROFILE.md](../../reference/query/SDA_PROFILE.md),
[FORMAT_SPEC.md](../../reference/storage/FORMAT_SPEC.md), [OVERVIEW.md](../../reference/product/OVERVIEW.md),
[DX_SPEC.md](../../reference/product/DX_SPEC.md), [CLUSTER_SPEC.md](../../todo/cluster/CLUSTER_SPEC.md),
[USP.md](../../reference/product/USP.md), [ARCHITECTURE.md](../../../ARCHITECTURE.md)
...
| Spec | Primary stages |
|------|----------------|
| [SDA_SPEC.md](../../reference/query/SDA_SPEC.md) | 0–1 |
| [FORMAT_SPEC.md](../../reference/storage/FORMAT_SPEC.md) | 2–3 |
| [OVERVIEW.md](../../reference/product/OVERVIEW.md) storage + recovery | 2–4, 6 |
| [SDA_PROFILE.md](../../reference/query/SDA_PROFILE.md) | 5 |
| [DX_SPEC.md](../../reference/product/DX_SPEC.md) | 4–7 |
| [CLUSTER_SPEC.md](../../todo/cluster/CLUSTER_SPEC.md) | 8+ |
| [USP.md](../../reference/product/USP.md) | product framing for all stages |
...
**Normative scope:** [SDA_SPEC.md](../../reference/query/SDA_SPEC.md) core + standalone profile,
...
**Normative scope:** [FORMAT_SPEC.md](../../reference/storage/FORMAT_SPEC.md) (frames, segments,
scanner, §13 wire tests); [OVERVIEW.md](../../reference/product/OVERVIEW.md) §§4, 6.
...
**Goal:** Host builds [SDA_PROFILE.md](../../reference/query/SDA_PROFILE.md) `ExaminationUnit` values;
...
**Normative scope:** [CLUSTER_SPEC.md](../../todo/cluster/CLUSTER_SPEC.md).
...
- Runbook: [doc/reference/operations/RUNBOOK_RETENTION.md](../../reference/operations/RUNBOOK_RETENTION.md).
...
23. ~~Stage 9 tiering / archive.~~ **Done** — segment move/copy, hierarchical
    ...
    runbook (`stage9_tiering.rs`, `doc/reference/operations/RUNBOOK_RETENTION.md`).

...
Status: **archived queue snapshot (2026-07-30); do not select work here**
Audience: humans + agents continuing the HEAP_SPEC / HP-010 program
Companions: [HEAP_SPEC.md](../../wip/heap/HEAP_SPEC.md) (contract + progress),
[spec/heap/qualification/hp010-matrix-v1.json](../../../spec/heap/qualification/hp010-matrix-v1.json),
[HEAP_COMPLETE_PATH_REVIEW.md](../../wip/heap/HEAP_COMPLETE_PATH_REVIEW.md),
...
| D2 | Commission **signed external security review** (brief already on file) | CPR-005 | Report under `doc/` + findings dispositioned. **Requires independent third party** — see [HEAP_H6_RESIDUAL_DISPOSITION.md](../../wip/heap/HEAP_H6_RESIDUAL_DISPOSITION.md). Cannot close by in-tree self-review. |
| D3 | Re-run complete-path review; close CPR-001…006 as honestly possible | H6 exit | [HEAP_COMPLETE_PATH_REVIEW.md](../../wip/heap/HEAP_COMPLETE_PATH_REVIEW.md) updated |
...
1. **D2 — procure external reviewer** (CPR-005). Not a code package: engage
   independent firm/researcher using [HEAP_EXTERNAL_SECURITY_REVIEW_BRIEF.md](../../wip/heap/HEAP_EXTERNAL_SECURITY_REVIEW_BRIEF.md);
   disposition in [HEAP_H6_RESIDUAL_DISPOSITION.md](../../wip/heap/HEAP_H6_RESIDUAL_DISPOSITION.md).

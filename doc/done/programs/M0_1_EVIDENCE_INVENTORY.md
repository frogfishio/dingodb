...
Scoreboard: M0-1 `accept` in [NEXT_BUILD_STATUS.md](../../wip/status/NEXT_BUILD_STATUS.md) after M0-2 reconciliation.
...
2. **M0-2** — update `doc/wip/status/NEXT_BUILD_STATUS.md` states from this table (do not mark HAR-1 accept).

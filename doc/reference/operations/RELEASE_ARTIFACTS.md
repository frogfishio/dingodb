...
Companion: [DEFECTS.md](../../done/incidents/DEFECTS.md) DEF-003, [CONTRIBUTING.md](../../../CONTRIBUTING.md)
...
- Root `README.md`, `CONTRIBUTING.md`, `LICENSE`, `LICENSE-MIT`,
  `LICENSE-MPL-2.0`, `LICENSE-AGPL-3.0`, `doc/reference/operations/LICENSING.md`, `VERSION`
- `doc/wip/status/CAPABILITY_MATRIX.md`, `doc/reference/operations/CRASH_CONSISTENCY.md`
- `doc/reference/operations/RUNBOOK_RETENTION.md`, `doc/reference/operations/BENCHMARK_DISCLOSURE.md`

...
[STUDIO_SPEC.md](../../todo/studio/STUDIO_SPEC.md).
...
use a [Residiuum Order Wavelet](../../todo/order-wavelets/ORDER_WAVELET_SPEC.md) to navigate exact
...
SDA (with ENR1) is the **mathematical** query language (see [SDA_SPEC.md](../query/SDA_SPEC.md)).
...
write queries: [doc/RQL/USER_GUIDE.md](../../RQL/USER_GUIDE.md). Design:
...
Normative detail: [doc/SDA/DIALECTS.md](../../SDA/DIALECTS.md), [RQL_SPEC.md](../../wip/query/RQL_SPEC.md).

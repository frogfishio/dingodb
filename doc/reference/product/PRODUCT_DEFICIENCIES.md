...
- [FUTURE_ROADMAP.md](../../todo/deferred/FUTURE_ROADMAP.md)
...
Use [ATOMICS_SPEC.md](../../todo/atomics/ATOMICS_SPEC.md), not a generic transaction façade.
...
Use [RRE_SPEC.md](../../todo/rre/RRE_SPEC.md). Document-local deterministic rules precede

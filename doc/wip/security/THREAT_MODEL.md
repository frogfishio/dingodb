...
Companion: [DEFECTS.md](../../done/incidents/DEFECTS.md) DEF-063, [FORMAT_SPEC.md](../../reference/storage/FORMAT_SPEC.md),
[CLUSTER_SPEC.md](../../todo/cluster/CLUSTER_SPEC.md), [doc/reference/operations/RUNBOOK_RETENTION.md](../../reference/operations/RUNBOOK_RETENTION.md).
...
4. **Wire still `1.0-draft`** — freeze checklist published
   ([WIRE_MAJOR1_FREEZE.md](../format/WIRE_MAJOR1_FREEZE.md)); residual soak, long fuzz,
...
| Supported-version policy | [SUPPORTED_VERSIONS.md](../../reference/operations/SUPPORTED_VERSIONS.md) |

...
| CSQ-8 | active | 2026-07-31 | CSQ-4, CSQ-5, CSQ-7 | `tests/csq8_derived_maintenance.rs` (9); `scripts/verify-csq-derived-maintenance.sh`; DEF-102/050/051/052/024 linked; suites DER/MNT/BAK/MIG → `active_csq8`; **board `in_review`** | principal accept CSQ-4/5/7 still open; tier reclaim interruption depth residual | maintenance qualification |

...
| FAS-0 | active | 2026-08-01 | CSQ-12 | Wave 0 inventory/migration; `formal/registry/*` full §12 catalogue (35 theorems) + §5 assumptions (8); `artifact-ownership-v1.json`; `scripts/check-formal-registry.sh` **structural_ok** + fail package accept until `FAS0_CLOSED`/CSQ-12; board FAS-0-T1/T2 labor | **not accept** — CSQ-12 scoreboard accept + `FAS0_CLOSED` + principal; full schema/linter residual | formal claim governance |

...
| RQL-Q3 | active | 2026-08-08 | RQL-Q2 family expressibility | **Q3.1–Q3.3** labor: oracle=force_scan=index (101/106); reopen×12; metamorphic 6/6; adversarial 16/16 (sparse/null/type/array/ties/partial-index/QVM+token mutate/reopen/inter-page/holes/budget/cancel/deadline/property×24/enrich card); one-command `bash scripts/verify-rql-q3.sh`; [RQL_Q3_1_SEMANTIC_ORACLE.md](../../todo/rql/RQL_Q3_1_SEMANTIC_ORACLE.md); [RQL_Q3_2_DIFFERENTIAL_MATRIX.md](../../todo/rql/RQL_Q3_2_DIFFERENTIAL_MATRIX.md); [RQL_Q3_3_ADVERSARIAL_SUITE.md](../../todo/rql/RQL_Q3_3_ADVERSARIAL_SUITE.md); **board Q3.1–Q3.3 `in_review`** | residual: page-concat `after`; principal package accept; not Gate-1 | semantic qualification |
| RQL-Q4 | active | 2026-08-08 | RQL-Q0 lanes; Q1 corpus (scaffold may precede Q3 claims) | **Q4.1–Q4.3** labor: `residiuum-rql-qual` architecture + datasets/cells + metrics collectors + shared-logical adapters (logical Ready digests; Mongo/CBL/server honest NotConfigured) + smoke evidence bundle; [RQL_Q4_1_HARNESS_ARCHITECTURE.md](../../todo/rql/RQL_Q4_1_HARNESS_ARCHITECTURE.md); [RQL_Q4_2_DATASET_CELLS.md](../../todo/rql/RQL_Q4_2_DATASET_CELLS.md); [RQL_Q4_3_METRICS_ADAPTERS.md](../../todo/rql/RQL_Q4_3_METRICS_ADAPTERS.md); `bash scripts/verify-rql-q4-harness.sh` 33/33; **board Q4.1–Q4.3 `in_review`** | residual: principal harness accept; Mongo/CBL drivers; product competitive execute; not Gate-1 | qualification harness |

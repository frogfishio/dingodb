...
| RQL-Q3 | active | 2026-08-08 | RQL-Q2 family expressibility | **Q3.1–Q3.4** labor: oracle=force_scan=index (101/106); reopen×12; metamorphic 6/6; adversarial 16/16; **page-concat** product `QueryRunOptions.after` laws 4/4 (+report); one-command `bash scripts/verify-rql-q3.sh`; [RQL_Q3_1_SEMANTIC_ORACLE.md](../../todo/rql/RQL_Q3_1_SEMANTIC_ORACLE.md); [RQL_Q3_2_DIFFERENTIAL_MATRIX.md](../../todo/rql/RQL_Q3_2_DIFFERENTIAL_MATRIX.md); [RQL_Q3_3_ADVERSARIAL_SUITE.md](../../todo/rql/RQL_Q3_3_ADVERSARIAL_SUITE.md); [RQL_Q3_4_PAGE_CONCAT.md](../../todo/rql/RQL_Q3_4_PAGE_CONCAT.md); **board Q3.1–Q3.4 `in_review`** | residual: source `after $cursor` corpus (5); principal package accept; not Gate-1 | semantic qualification |
| RQL-Q4 | active | 2026-08-08 | RQL-Q0 lanes; Q1 corpus (scaffold may precede Q3 claims) | **Q4.1–Q4.3** labor scaffold `in_review`; **pre-accept findings board** [RQL_Q34_PREACCEPT_FINDINGS.md](../../todo/rql/RQL_Q34_PREACCEPT_FINDINGS.md) Feature `019fdfaf-e590…` F1–F9 **todo** (P1: embedded compile, §7.2 real cells, Point sel align, 0.01% generator; P2: logical identity, metric residual, evidence nondet; …). Q5+ hold until P1 closed. | residual: F1–F4 P1 before accept/Q5; Mongo/CBL drivers; not Gate-1 | qualification harness |

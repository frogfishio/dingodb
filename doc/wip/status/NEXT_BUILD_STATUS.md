...
| RQL-Q4 | active | 2026-08-08 | RQL-Q0 lanes; Q1 corpus (scaffold may precede Q3 claims) | **Q4.1–Q4.2** labor: crate `residiuum-rql-qual` architecture + dataset axes/generators + lifecycle honesty + mandatory cell plans 1–12 (conc 1/2/4/8+oversub, sel×5, life×7); schemas `harness-v1/`; [RQL_Q4_1_HARNESS_ARCHITECTURE.md](../../todo/rql/RQL_Q4_1_HARNESS_ARCHITECTURE.md); [RQL_Q4_2_DATASET_CELLS.md](../../todo/rql/RQL_Q4_2_DATASET_CELLS.md); `bash scripts/verify-rql-q4-harness.sh` 26/26; **board Q4.1+Q4.2 `in_review`** | residual: Q4.3 Mongo/CBL/server adapters+metrics+execute; principal design accept; not competitive | qualification harness |

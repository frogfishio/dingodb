...
Updated: 2026-08-02 (**P0:** [DEF-SCAN-001](./DEF_SCAN_001_SEGMENT_NOT_FOUND.md) T5 **in_review** (LocatorFault + examine budget); T6 **in_review** — wire `next_after_key`=last examined key (blocker #3); no package accept; query spine / APB **in_review**)

...
Updated: 2026-08-02 (**P0:** [DEF-SCAN-001](./DEF_SCAN_001_SEGMENT_NOT_FOUND.md) T7–T11 labor accepted (blockers through #5); T12 **in_review** — `scan_collection_page` + fail-closed legacy `scan_collection` → `Vec`; package **not** accepted; query spine / APB **in_review**)

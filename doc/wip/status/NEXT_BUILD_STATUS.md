...
| RQL-Q4 | active | 2026-08-08 | RQL-Q0 lanes; Q1 corpus (scaffold may precede Q3 claims) | **Q4.1–Q4.3** labor scaffold `in_review`; **pre-accept findings** [RQL_Q34_PREACCEPT_FINDINGS.md](../../todo/rql/RQL_Q34_PREACCEPT_FINDINGS.md) Feature `019fdfaf-e590…` **F1–F9 labor `in_review`** (P1 F1–F4 + P2 F5–F8 + P3 F9). Verify: `verify-rql-q3.sh` + `verify-rql-q4-harness.sh` PASS (F8 no-spec-churn; embedded feature 44/44). **Q5+ hold** until principal accepts P1 honesty / package path. | residual: **principal accept** of pre-accept P1 (then allow Q5 intake); Mongo/CBL drivers; not Gate-1 | qualification harness |

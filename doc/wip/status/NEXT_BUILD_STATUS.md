...
Updated: 2026-08-01 (APB-1 **active** G1–G4 + G6 dual-suite scaffold; APP-5 **accept**; APP-4/APB-0 accept)
...
| APB-1 | active | 2026-08-01 | APB-0, HAR-1 | inventory + **G1–G4 + G6 scaffold:** sealed backends; create/open/list + put/get/delete + history + IndexManager; shared `apb1_facade_parity` pack (embedded full + remote collection-plane); [APB1_DUAL_BACKEND_SUITE.md](../../todo/application-baseline/APB1_DUAL_BACKEND_SUITE.md); [APB1_CLIENT_GAP_INVENTORY.md](../../todo/application-baseline/APB1_CLIENT_GAP_INVENTORY.md) v1.5 | G6 exit residual (remote create/HeapAdmin); HAR-1 scoreboard stale; **no package accept** | backend-neutral client |
...
3. **Query spine** (principal §0.8): **APP-4/APP-5 = accept**; **APB-1 active** (G1–G4 + G6 scaffold; dual exit residual);
...
| 5 | **APP-4 → APP-5 → APB-7** | APP-4/5 **accept**; **APB-1 active** (G1–G4 + G6 scaffold); still need G6 exit + APB-6/APP-6 for APB-7 path |

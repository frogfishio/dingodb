...
Updated: 2026-08-08 (**RQL-Q0** package **ACCEPT**; pre-accept F1–F9 labor `in_review` — not Gate-1 / not Q3–Q4 package accept).
...
| RQL-Q2 | active | 2026-08-08 | RQL-Q1 accept; Decision-0 honesty for one-runtime *exit claim* | Q2.1–Q2.3 labor; **Q2.2d** budget soft-stop under IncompleteAllowed; re-audit **134**/147 expressible (gap 11); multi-frontend QVM identity 7/7; [RQL_Q2_3_FRONTEND_QVM_EXIT_PACK.md](../../todo/rql/RQL_Q2_3_FRONTEND_QVM_EXIT_PACK.md); [RQL_Q2_2D_BUDGET_PARTIAL.md](../../todo/rql/RQL_Q2_2D_BUDGET_PARTIAL.md); D0 OPEN → **no package exit / no C1** | residual: computed conditional project (5), cursor `after` (5), enrich within (1); principal D0 disposition; **no package accept** | capability closure |
| RQL-Q3 | active | 2026-08-08 | RQL-Q2 family expressibility | **Q3.1–Q3.4** labor `in_review` + pre-accept F7/F9 honesty: oracle_ok=101 matrix_equal=101; adversarial incl. token replay + Available inter-page; page-concat laws 4/4; one-command `bash scripts/verify-rql-q3.sh` PASS (F8 target-only reports); [RQL_Q3_1_SEMANTIC_ORACLE.md](../../todo/rql/RQL_Q3_1_SEMANTIC_ORACLE.md); [RQL_Q3_2_DIFFERENTIAL_MATRIX.md](../../todo/rql/RQL_Q3_2_DIFFERENTIAL_MATRIX.md); [RQL_Q3_3_ADVERSARIAL_SUITE.md](../../todo/rql/RQL_Q3_3_ADVERSARIAL_SUITE.md); [RQL_Q3_4_PAGE_CONCAT.md](../../todo/rql/RQL_Q3_4_PAGE_CONCAT.md); [RQL_Q34_PREACCEPT_FINDINGS.md](../../todo/rql/RQL_Q34_PREACCEPT_FINDINGS.md) | residual: source `after $cursor` corpus (5); **principal package accept**; not Gate-1 | semantic qualification |
| RQL-Q4 | active | 2026-08-08 | RQL-Q0 lanes; Q1 corpus (scaffold may precede Q3 claims) | **Q4.1–Q4.3** labor scaffold `in_review`; **pre-accept findings** [RQL_Q34_PREACCEPT_FINDINGS.md](../../todo/rql/RQL_Q34_PREACCEPT_FINDINGS.md) Feature `019fdfaf-e590…` **F1–F9 labor `in_review`** (P1 F1–F4 + P2 F5–F8 + P3 F9). Verify: `verify-rql-q3.sh` + `verify-rql-q4-harness.sh` PASS (F8 no-spec-churn; embedded feature 44/44). **Q5+ hold** until principal accepts P1 honesty / package path. | residual: **wave-2 P1 F10–F14** [RQL_Q4_FAITHFULNESS_FINDINGS.md](../../todo/rql/RQL_Q4_FAITHFULNESS_FINDINGS.md) before Q4 accept/Q5; principal accept F1–F9; Mongo/CBL drivers; not Gate-1 | qualification harness |

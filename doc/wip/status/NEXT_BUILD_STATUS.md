...
| RQL-Q3 | active | 2026-08-08 | RQL-Q2 family expressibility | **Q3.1** oracle + **Q3.2** differential matrix labor: oracle=force_scan_QVM=index (101/106); reopen×12; `_key` product bind; metamorphic 6/6; [RQL_Q3_1_SEMANTIC_ORACLE.md](../../todo/rql/RQL_Q3_1_SEMANTIC_ORACLE.md); [RQL_Q3_2_DIFFERENTIAL_MATRIX.md](../../todo/rql/RQL_Q3_2_DIFFERENTIAL_MATRIX.md); `bash scripts/verify-rql-q3-oracle.sh`; **board Q3.1+Q3.2 `in_review`** | residual: Q3.3 adversarial+one-command; page-concat `after`; principal package accept | semantic qualification |

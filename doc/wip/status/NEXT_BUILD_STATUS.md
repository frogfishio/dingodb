...
| RQL-Q3 | active | 2026-08-08 | RQL-Q2 family expressibility | **Q3.1:** test-only independent semantic oracle (`rql_q3_semantic_oracle`); full logical-fixture scan; no index/plan selection; **101**/106 Tier-A oracle_rule sources `oracle_ok` (5 `after` unsupported); [RQL_Q3_1_SEMANTIC_ORACLE.md](../../todo/rql/RQL_Q3_1_SEMANTIC_ORACLE.md); `bash scripts/verify-rql-q3-oracle.sh`; report `q3_1_oracle_report.json`; **board `in_review` Q3.1** | residual: Q3.2 differential+metamorphic; Q3.3 adversarial+one-command; principal package accept | semantic qualification |

...
| RQL-Q4 | active | 2026-08-08 | RQL-Q0 lanes; Q1 corpus (scaffold may precede Q3 claims) | **Q4.1** harness architecture labor: crate `residiuum-rql-qual` (lanes E/S, fixture index, engine trait+stubs, canonicalize digests, §7.4 metrics types, evidence fingerprint/bundle); schemas `spec/rql/qualification/harness-v1/`; [RQL_Q4_1_HARNESS_ARCHITECTURE.md](../../todo/rql/RQL_Q4_1_HARNESS_ARCHITECTURE.md); `bash scripts/verify-rql-q4-harness.sh`; **board Q4.1 `in_review`** | residual: Q4.2 cells; Q4.3 Mongo/CBL/server adapters+metrics; principal design accept; not competitive | qualification harness |

...
**RQL-Q1 admitted** — Q1.1 scaffold + **Q1.2 Commerce/Messaging bulk** landed; claim Q1.3 next. CRITICAL_PATH RQL→Atomics→Cluster.
...
| RQL-Q1 | active | 2026-08-07 | RQL-Q0 accept | Q1.1 scaffold + **Q1.2**: `rql-q1-corpus-v0.2.0` **54** draft cases (commerce 33 / messaging 21); generators + `tools/rql_q1/materialise_fixture.py`; [RQL_Q1_CORPUS.md](../../todo/rql/RQL_Q1_CORPUS.md); `bash scripts/verify-rql-q1-corpus.sh` exit 0; floors not enforced (selection 20/20 only) | Q1.3 domains + floor fill; Q1.4 enforce; **no package accept** | practical query corpus |

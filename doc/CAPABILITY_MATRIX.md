...
| Parallel ingest / multi-core write | **design only** | Single exclusive writer + one active segment today; DEF-096 / `doc/PARALLEL_INGEST.md` sequences async lifecycle → sharded writers → horizontal. 10 GiB M4 run showed CPU/SSD headroom after DEF-095 |

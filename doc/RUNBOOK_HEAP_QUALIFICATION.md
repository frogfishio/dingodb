...
| Remote connect_heap | `cargo test -p dingo-sdk --features dangerous-key-export --test hp007_connect_heap` | Welcome + ping; put/get/delete; list_collections/list_keys/scan_json; wrong name rejects |

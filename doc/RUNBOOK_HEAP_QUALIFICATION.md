...
| Remote connect_heap | `cargo test -p dingo-sdk --features dangerous-key-export --test hp007_connect_heap` | Welcome + ping; put/get/delete; list/scan/find; wrong name rejects |

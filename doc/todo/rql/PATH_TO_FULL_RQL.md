...
**Phase 3** [PHASE3_FULL_RQL_KICKOFF.md](./PHASE3_FULL_RQL_KICKOFF.md) — kickoff + many/facade + candidate where + **within** (T3.4) labor; nested-within / multi-enrich / `at rank` still residual  

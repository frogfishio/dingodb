...
Status: **labor 2026-08-05** · card `89a80e77` (kickoff) + **T3.2** `51c260a8`  
Profile **`rql-full-v1`**  
...
| Enrich candidate `where` | **residual** |
...
Evidence: `doc/todo/rql/evidence/phase3_many_facade.log`
...
1. Enrich candidate `where` predicate.
2. `within` nested carrier.
3. Chained / multi enrich.
4. Only then `at rank` / access policies (DDA-dependent).

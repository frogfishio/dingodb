...
- [HEAP_APPLICATION_READY_PLAN.md](../heap-application-ready/HEAP_APPLICATION_READY_PLAN.md)
...
- claim-to-evidence entries in `doc/wip/status/VERIFICATION_STATUS.md`.

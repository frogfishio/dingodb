...
**AWO-0 T1 labor complete** (`AWO-0_T1_CONTRACT_RESIDUAL_CHECKLIST.md`): contracts
verify green; E1–E6 stamped; not package accept. Next: **AWO-0 T2** pure model +
goldens. Product write-path mutation requires AWO-0 accept. Master-plan AWO
admission remains a principal residual (E1).